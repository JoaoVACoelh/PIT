                        ...
                        <form class="space-y-6" action="#" method="POST">
                            ...
                            <div>
                                <div class="flex items-center justify-between flex-wrap">
                                    <label for="password"
                                        class="block text-sm font-medium leading-6 text-gray-900 pr-1">Senha</label>
                                    <div class="text-sm">
                                        <a href="RecupSenha.php"
                                            class="font-semibold text-indigo-900 hover:text-indigo-500">Esqueceu
                                            sua Senha?</a>
                                    </div>
                                </div>
                                <div class="mt-2">
