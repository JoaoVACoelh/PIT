            ...
            <div class="lg:w-1/2">
                <div class="flex flex-col justify-center px-6 py-12 lg:px-8 bg-zinc-100 rounded-lg">
                    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                        <h2 class="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Troca de
                            Senha
                        </h2>
                    </div>
                    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        <form class="space-y-6" action="#" method="POST">
                            <div>
                                <label for="Nova-Senha" class="block text-sm font-medium leading-6 text-gray-900">Senha
                                    Nova</label>
                                <div class="mt-2">
                                    <input id="Nova-senha" name="Nova-Senha" type="text" required
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div>
                                <label for="codigo" class="block text-sm font-medium leading-6 text-gray-900">Informe o
                                    código</label>
                                <div class="mt-2">
                            ...
                            <div>
                                <button type="submit" name="ok"
                                    class="flex w-full justify-center rounded-md bg-neutral-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-neutral-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Trocar
                                    Senha</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="termo.html" class="hover:underline">Termo de Uso</a>
                            </li>
                            <li class="mb-4">
                                <a href="limitesdepeso.html" class="hover:underline">Política de Peso</a>
                            </li>
                            <li class="mb-4">
                                <a href="politica.php" class="hover:underline">Política de Reembolso</a>
                            </li>
                            <li class="mb-4">
                                <a href="suporte.html" class="hover:underline">Suporte</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4">
                                <a href="RecrutamentoMotorista.php" class="hover:underline">Carreiras</a>
                            </li>
                            <li class="mb-4">
                                <a href="suporte.html" class="hover:underline">Contato</a>
                            </li>
                        </ul>
                    </div>
                    <div>
