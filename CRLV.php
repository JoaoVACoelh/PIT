...
<body>
    <header class="bg-black h-16 flex items-center justify-between pr-10 pl-10 p-2 sticky top-0 z-10">
        <div>
    ...
    <div class="h-screen flex items-center justify-center">
        <div class="flex z-1">
            <div class="card" style="width: 26rem;">
                <img src="img/selfie.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Foto de Perfil</h5>
                    <p class="card-text">Anexe seu Certificado de registro e licenciamento de veículo aqui.</p>
