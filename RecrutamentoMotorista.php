    ...
    <div class="h-screen flex items-center justify-center">
        <form action="page.php">
            ...
            <div class="container text-center mt-5">
                ...
                <div class="row mb-4">
                    <div class="col-sm-8">
                        <p class="fw-semibold fs-4 pb-2 mb-4  border-bottom border-black">Etapas obrigatórias serem
                            feitas para a conclusão do cadastro.</p>
                    </div>
                </div>

                <div class="row ">
                    <div class="list-group list-group-flush">
                        <a href="FotoDePerfil.php" class="list-group-item list-group-item-action fs-5">Foto de
                            Perfil</a>
                        <a href="CNH.php" class="list-group-item list-group-item-action fs-5">Carteira de
                            Habilitação</a>
                        <a href="CRLV.php" class="list-group-item list-group-item-action fs-5">Certificado de Registro e
                            Licenciamento de veículo</a>
                    </div>
                </div>
