      ...
      <div class="lg:w-1/2">
        <div class="flex flex-col justify-center px-6 w-full py-12 lg:px-8 bg-zinc-100 rounded-lg">
          <div
            ...
            <h2
              class="text-center p-3 text-1xl font-semibold leading-9 tracking-tight text-white basis-1/2 bg-neutral-800 rounded-md hover:bg-neutral-600 hover:cursor-pointer">
              Login</h2>
            ...
            <form class="space-y-6" action="#" method="POST">
              ...
              <div>
                <div class="flex items-center justify-between flex-wrap">
                  ...
                  <div class="text-sm">
                    <a href="RecupSenha.php" class="font-semibold text-indigo-900 hover:text-indigo-500">Esqueceu sua
                      Senha?</a>
                  </div>
                </div>
                <div class="mt-2">
              ...
              <div>
                <label for="nome" class="block text-sm font-medium leading-6 text-gray-900">E-mail</label>
                <div class="mt-2">
